...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <?php
            ...
            include "koneksi.php";
              if(isset($_GET['kode'])){
                mysqli_query($koneksi,"delete from data_club where nama='$_GET[kode]'");

                  echo '<div class="alert alert-danger" role="alert">
                      <span class="badge badge-pill badge-success"></span>Data Club Berhasil Di Hapus
                       </div>
                         </div>';
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                               ...
                               <a href="input_data_club.php"> <button type="submit" class="btn btn-primary btn-sm" name="simpan">
                                                            <i class="fa fa-plus"></i>Tambah Data Club
                                                        </button></a>
                                    <strong class="card-title">Data Club</strong><br>
...
<!-- vlidasi simpan akun -->
                                     ...
                                     include "koneksi.php";
                                      if (isset($_GET['cari'])){
                                        $pencarian = $_GET['cari'];
                                        $query = "select * from data_club where kode like '%".$pencarian."%' or nama like '%".$pencarian."%' or kota like '%".$pencarian."%'" ;
                                        
                                      }else{
                                        $query="select * from data_club";
                                      }
                                     $no=1;
